...
- [x] **Step 4: 写 tasks.md + spec.md + .openspec.yaml**
...
- [x] **Step 2: 单测 src/types/__tests__/diary.test.ts**
...
- [x] **Step 2: gen-tabbar-icons.mjs 加日记条目**
...
- [x] **Step 4: app.config.ts 四 tab + 页面**
...
- [x] **Step 3: components/index.ts 导出**
...
- [x] **Step 3: components/index.ts 导出 + tsc + 提交**
...
- [x] **Step 2: 写 edit.scss**（标题 input、区块间距，沿用主题 token）
...
- [x] **Step 2: 写 detail.scss**

- [x] **Step 3: tsc + weapp 编译 + 提交**
